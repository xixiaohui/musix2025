 ...
 *
 * Long-pressing a card shows a confirmation dialog to remove it from favorites.
 *
...
fun FavoritesScreen(
    ...
    ringtoneToRemove?.let { ringtone ->
        AlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(R.string.remove_from_favorites_title),
                    style = MaterialTheme.typography.titleLarge
                )
            },
            text = {
                Text(
                    text = stringResource(R.string.remove_from_favorites_message, ringtone.title),
                    style = MaterialTheme.typography.bodyMedium
                )
            },
            confirmButton = {
                TextButton(onClick = {
                    viewModel.removeFavorite(ringtone.id)
